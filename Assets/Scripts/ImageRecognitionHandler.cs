...
public class ImageRecognitionHandler : MonoBehaviour
{
    ...
    private Dictionary<string, GameObject> _zoneContainers;

    [SerializeField]
    private GameObject virutalObjectContainer;
    ...
    private void Start()
    {
        ...
        _zoneContainers = GetImmediateChildrenGameObjects(virutalObjectContainer);
    }
